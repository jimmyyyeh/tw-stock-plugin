...
class StockPERatioObject:
    def __init__(self, yield_ratio, pbr, per, code=None, name=None, dividend_year=None, date_=None, year=None,
    ...
    def _format_value(self):
        float_keys = {'per', 'dividend_per_share', 'dividend_year', 'yield_ratio', 'pbr'}
